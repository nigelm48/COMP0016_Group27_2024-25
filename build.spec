...
# Get site-packages directory to include data files
site_packages = site.getsitepackages()[0]
emoji_path = os.path.join(site_packages, 'emoji')
...
a = Analysis(
    ...
    datas=[
        ...
        # Include emoji data files
        (emoji_path, 'emoji'),
        # Include entire chromadb package
    ...
    hiddenimports=[
        ...
        # Emoji package (with unicode codes)
        'emoji',
        'emoji.core',
        'emoji.unicode_codes',
        'emoji.unicode_codes.en',
